...
| 단계 | 시간예산 | 내용 | 출구 게이트 |
|---|---|---|---|
| **W0 스파이크** | 20~30h | §7의 4개 스파이크 — ✅ ①②③ 빌드 완료(`prototype/`, `prototype-boarding/`), ⬜ ④ 실기기 측정 | 4개 전부 판정 완료 |
| **v0.1 «포격전»** | 80~120h | ✅ **빌드 완료(`v01/`) — 계획을 초과 달성**: 해도 3스테이지+별 평가+은화·조선소·선술집 가챠에 **3막 풀 사이클(포격→총격→백병전)**까지 포함. 남은 것: 퍼블리시(공개 출시) + 지표 측정 | 썸네일 CTR·첫 60초 이탈·세션 길이·p50 fps 측정 |
